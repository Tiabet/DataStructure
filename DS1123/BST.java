...
public class BST <T extends Comparable<T>> implements Iterable<T>
{
   ...
   /**
    * INSERT, SEARCH< DELETE는 모두 재귀적으로 구성되어있음
    */
/*****************************************************
*
*            INSERT
*
******************************************************/
   public void insert(T data) //크면 오른쪽, 작으면 왼쪽에 넣는 메소드
   {
      root = insert(root, data);
   }
   private Node<T> insert(Node<T> p, T toInsert)//p가 부모 노드, toInsert가 넣으려는 노드
   {
      if (p == null)
